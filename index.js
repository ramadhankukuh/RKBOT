...
const { vituranime } = require('./src/vituranime');
		...
		try {
			...
			switch(command) {
				...
				case 'menu':
					...
					break
				case 'vituranime':
					client.sendMessage(from, vituranime(prefix), text)
					break
				case 'donate':
				    client.sendMessage(from, donate(prefix), text)
				    break
				case 'snk':
				    client.sendMessage(from, snk(prefix), text)
				    break
				case 'requests':
				    client.sendMessage(from, requests(prefix), text)
				    break
				case 'ownermenu':
			...
			case 'creator':
                 ...
                 client.sendMessage(from, 'itu owner ku, save yaaa ><',MessageType.text, { quoted: mek} )
                 break
                 case 'fitnah':	
				case 'fake':          
                ...
                case 'Iri':
					case 'iri?':
            case 'iri':
                client.sendMessage(from, 'mp3/PTT-20201221-WA0596.mp3', {quoted: mek, ptt:true})
                break
            case 'abgjago':
            case 'abangjago':
